...
class Vec2 {
     ...
     */
    static create(x: number = 0, y: number = 0): MathTypes['vec2'] {
    ...
    /**
     * ベクトルの長さ（大きさ）を返す
     * @param {MathTypes['vec2']} v - ２つの要素を持つベクトル
     * @return {number} ベクトルの長さ（大きさ）
     */
    static length(v: MathTypes['vec2']): number {
        return Math.sqrt(v[0] * v[0] + v[1] * v[1]);
    }
    /**
     * ベクトルを正規化した結果を返す
     * @param {MathTypes['vec2']} v - ２つの要素を持つベクトル
     * @return {MathTypes['vec2']} 正規化したベクトル
     */
    static normalize(v: MathTypes['vec2']): MathTypes['vec2'] {
        const n = Vec2.create();
    ...
    /**
     * ２つのベクトルの内積の結果を返す
     * @param {MathTypes['vec2']} v0 - ２つの要素を持つベクトル
     * @param {MathTypes['vec2']} v1 - ２つの要素を持つベクトル
     * @return {number} 内積の結果
     */
    static dot(v0: MathTypes['vec2'], v1: MathTypes['vec2']): number {
     ...
     * @return {number} 外積の結果
     */
    static cross(v0: MathTypes['vec2'], v1: MathTypes['vec2']): number {
...
class Vec3 {
     ...
     * @return {Float32Array} ベクトル格納用の配列
     */
    static create(x: number = 0, y: number = 0, z: number = 0): MathTypes['vec3'] {
    ...
    /**
     * ベクトルの長さ（大きさ）を返す
     * @param {MathTypes['vec3']} v - ３つの要素を持つベクトル
     * @return {number} ベクトルの長さ（大きさ）
     */
    static length(v: MathTypes['vec3']): number {
        return Math.sqrt(v[0] * v[0] + v[1] * v[1] + v[2] * v[2]);
    }
    /**
     * ベクトルを正規化した結果を返す
     * @param {MathTypes['vec3']} v - ３つの要素を持つベクトル
     * @return {MathTypes['vec3']} 正規化したベクトル
     */
    static normalize(v: MathTypes['vec3']): MathTypes['vec3'] {
        const n = Vec3.create();
    ...
    /**
     * ２つのベクトルの内積の結果を返す
     * @param {MathTypes['vec3']} v0 - ３つの要素を持つベクトル
     * @param {MathTypes['vec3']} v1 - ３つの要素を持つベクトル
     * @return {number} 内積の結果
     */
    static dot(v0: MathTypes['vec3'], v1: MathTypes['vec3']): number {
     ...
     * @param {MathTypes['vec3']} v0 - ３つの要素を持つベクトル
     * @param {MathTypes['vec3']} v1 - ３つの要素を持つベクトル
     * @return {MathTypes['vec3']} 外積の結果
     */
    static cross(v0: MathTypes['vec3'], v1: MathTypes['vec3']): MathTypes['vec3'] {
        return Vec3.create(
            v0[1] * v1[2] - v0[2] * v1[1],
            v0[2] * v1[0] - v0[0] * v1[2],
            v0[0] * v1[1] - v0[1] * v1[0]
     ...
     * @param {MathTypes['vec3']} v0 - ３つの要素を持つベクトル
     * @param {MathTypes['vec3']} v1 - ３つの要素を持つベクトル
     * @param {MathTypes['vec3']} v2 - ３つの要素を持つベクトル
     * @return {MathTypes['vec3']} 面法線ベクトル
     */
    static faceNormal(v0: MathTypes['vec3'], v1: MathTypes['vec3'], v2: MathTypes['vec3']): MathTypes['vec3'] {
...
class Mat4 {
     ...
     */
    static create(): MathTypes['mat4'] {
        return new Float32Array(16);
    }
    /**
     * 行列を単位化する（参照に注意）
     * @param {MathTypes['mat4']} dest - 単位化する行列
     * @return {MathTypes['mat4']} 単位化した行列
     */
    static identity(dest?: MathTypes['mat4']): MathTypes['mat4'] {
     ...
     * @param {MathTypes['mat4']} mat - 適用を受ける行列
     * @param {MathTypes['vec3']} vec - XYZ の各軸に対して拡縮を適用する値の行列
     * @param {MathTypes['mat4']} [dest] - 結果を格納する行列
     * @return {MathTypes['mat4']} 結果の行列
     */
    static scale(mat: MathTypes['mat4'], vec: MathTypes['vec3'], dest?: MathTypes['mat4']): MathTypes['mat4'] {
        const out = dest == null ? Mat4.create() : dest;
        out[0] = mat[0] * vec[0];
        out[1] = mat[1] * vec[0];
        out[2] = mat[2] * vec[0];
     ...
     * @param {MathTypes['mat4']} mat - 適用を受ける行列
     * @param {MathTypes['vec3']} vec - XYZ の各軸に対して平行移動を適用する値の行列
     * @param {MathTypes['mat4']} [dest] - 結果を格納する行列
     * @return {MathTypes['mat4']} 結果の行列
     */
    static translate(mat: MathTypes['mat4'], vec: MathTypes['vec3'], dest?: MathTypes['mat4']): MathTypes['mat4'] {
        const out = dest == null ? Mat4.create() : dest;
        out[0] = mat[0];
        out[1] = mat[1];
        out[2] = mat[2];
     ...
     * @param {MathTypes['vec3']} axis - 回転の軸
     * @param {MathTypes['mat4']} [dest] - 結果を格納する行列
     * @return {MathTypes['mat4']} 結果の行列
     */
    static rotate(
     ...
     * @param {MathTypes['vec3']} eye - 視点位置
     * @param {MathTypes['vec3']} center - 注視点
     * @param {MathTypes['vec3']} up - 上方向を示すベクトル
     * @param {MathTypes['mat4']} [dest] - 結果を格納する行列
     * @return {MathTypes['mat4']} 結果の行列
     */
    static lookAt(
        eye: MathTypes['vec3'],
        center: MathTypes['vec3'],
        up: MathTypes['vec3'],
        dest?: MathTypes['mat4']
    ): MathTypes['mat4'] {
        const out = dest == null ? Mat4.create() : dest;
     ...
     * @param {MathTypes['mat4']} mat - 適用する行列
     * @param {MathTypes['mat4']} [dest] - 結果を格納する行列
     * @return {MathTypes['mat4']} 結果の行列
     */
    static transpose(mat: MathTypes['mat4'], dest?: MathTypes['mat4']): MathTypes['mat4'] {
        const out = dest == null ? Mat4.create() : dest;
        out[0] = mat[0];
        out[1] = mat[4];
        out[2] = mat[8];
     ...
     * @return {MathTypes['mat4']} 結果の行列
     */
    static inverse(mat: MathTypes['mat4'], dest?: MathTypes['mat4']): MathTypes['mat4'] {
        const out = dest == null ? Mat4.create() : dest;
        const a = mat[0],
            b = mat[1],
            c = mat[2],
     ...
     */
    static toVecIV(mat: MathTypes['mat4'], vec: number[] | Float32Array): Float32Array {
        const a = mat[0],
            b = mat[1],
            c = mat[2],
            d = mat[3],
     ...
     * @param {MathTypes['mat4']} mat - MVP 行列
     * @param {MathTypes['vec3']} vec - MVP 行列と乗算するベクトル
     * @param {number} width - ビューポートの幅
     * @param {number} height - ビューポートの高さ
     * @return {MathTypes['vec2']} 結果のベクトル
     */
    static screenPositionFromMvp(
        ...
        if (v[3] <= 0.0) {
            return Float32Array.of(NaN, NaN) as MathTypes['vec2'];
        }
        v[0] /= v[3];
        v[1] /= v[3];
        v[2] /= v[3];
...
class Qtn {
     ...
     * @return {MathTypes['qtn']} クォータニオンデータ格納用の配列
     */
    static create(): MathTypes['qtn'] {
        return new Float32Array(4);
    }
    /**
     * クォータニオンを初期化する（参照に注意）
     * @param {MathTypes['qtn']} dest - 初期化するクォータニオン
     * @return {MathTypes['qtn']} 結果のクォータニオン
     */
    static identity(dest?: MathTypes['qtn']): MathTypes['qtn'] {
     ...
     * @param {MathTypes['qtn']} qtn - 元となるクォータニオン
     * @param {MathTypes['qtn']} [dest] - 結果を格納するクォータニオン
     * @return {MathTypes['qtn']} 結果のクォータニオン
     */
    static inverse(qtn: MathTypes['qtn'], dest?: MathTypes['qtn']): MathTypes['qtn'] {
        const out = dest == null ? Qtn.create() : dest;
        out[0] = -qtn[0];
        out[1] = -qtn[1];
        out[2] = -qtn[2];
     ...
     * @return {MathTypes['qtn']} 結果のクォータニオン
     */
    static normalize(qtn: MathTypes['qtn']): MathTypes['qtn'] {
     ...
     * @param {MathTypes['qtn']} qtn0 - 乗算されるクォータニオン
     * @param {MathTypes['qtn']} qtn1 - 乗算するクォータニオン
     * @param {MathTypes['qtn']} [dest] - 結果を格納するクォータニオン
     * @return {MathTypes['qtn']} 結果のクォータニオン
     */
    static multiply(qtn0: MathTypes['qtn'], qtn1: MathTypes['qtn'], dest?: MathTypes['qtn']): MathTypes['qtn'] {
        const out = dest == null ? Qtn.create() : dest;
        const ax = qtn0[0],
            ay = qtn0[1],
            az = qtn0[2],
     ...
     * @param {MathTypes['vec3']} axis - ３つの要素を持つ軸ベクトル
     * @param {MathTypes['qtn']} [dest] - 結果を格納するクォータニオン
     * @return {MathTypes['qtn']} 結果のクォータニオン
     */
    static rotate(angle: number, axis: MathTypes['vec3'], dest?: MathTypes['qtn']): MathTypes['qtn'] {
        const out = dest == null ? Qtn.create() : dest;
        let a = axis[0],
            b = axis[1],
            c = axis[2];
     ...
     * @param {MathTypes['vec3']} vec - ３つの要素を持つベクトル
     * @param {MathTypes['qtn']} qtn - クォータニオン
     * @param {MathTypes['vec3']} [dest] - ３つの要素を持つベクトル
     * @return {MathTypes['vec3']} 結果のベクトル
     */
    static toVecIII(vec: MathTypes['vec3'], qtn: MathTypes['qtn'], dest?: MathTypes['vec3']): MathTypes['vec3'] {
     ...
     * @param {MathTypes['qtn']} qtn - クォータニオン
     * @param {MathTypes['mat4']} [dest] - 4x4 行列
     * @return {MathTypes['mat4']} 結果の行列
     */
    static toMatIV(qtn: MathTypes['qtn'], dest?: MathTypes['mat4']): MathTypes['mat4'] {
        const out = dest == null ? Mat4.create() : dest;
        const x = qtn[0],
            y = qtn[1],
            z = qtn[2],
     ...
     * @param {MathTypes['qtn']} qtn0 - クォータニオン
     * @param {MathTypes['qtn']} qtn1 - クォータニオン
